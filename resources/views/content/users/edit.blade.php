                        ...
                        <div class="row">
                                ...
                                <div class="mb-2 row align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                       <div class="form-check form-switch mb-2">
                                            <input name="status" class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" {{ $user->status ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                               <div class="mb-2 row align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="email" value="{{ $user->email }}" class="form-control" id="email" placeholder="e.g. abc@example.com" />
                                    </div>
                                </div>
                               <div class="mb-2 row align-items-center">
            ...
            $('#submit').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            showToast("User updated successfully!", "Success", "primary");
                            setTimeout(() => {
